...
try {
    ...
    Write-Host "✔ Successfully installed @agent-remote/cli!" -ForegroundColor Green
    Write-Host ""
    ...
    Write-Host "⚠️ Global install requires administrator permissions or custom npm prefix." -ForegroundColor Yellow
