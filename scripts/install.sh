...
if ! command -v node >/dev/null 2>&1; then
    ...
    echo -e "\033[1;33m👉 Please install Node.js via nvm (https://github.com/nvm-sh/nvm) or your package manager.\033[0m"
    exit 1
fi

NODE_VERSION=$(node -v)
echo -e "\033[1;32m✔ Found Node.js: ${NODE_VERSION}\033[0m"
...
if npm install -g @agent-remote/cli --loglevel=error 2>/dev/null; then
    echo -e "\033[1;32m✔ Successfully installed @agent-remote/cli!\033[0m"
    echo ""
    echo -e "\033[1;36m🚀 To start your agent harness in any repository, simply run:\033[0m"
    echo -e "   \033[1;32magent-remote\033[0m"
    echo ""
else
    echo -e "\033[1;33m⚠️ Standard npm global install requires root/sudo or configured npm prefix.\033[0m"
