...
1. From anywhere on the local network or cellular data, the developer taps the mobile prompt bar and types: *"Refactor the auth middleware to support refresh tokens and write unit tests."*
